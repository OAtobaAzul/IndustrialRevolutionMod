...
--currently just a default generator, will redo once power rework is done.
--for the sake of keeping the default generator existing, in case skins are added, Winona will have a exclusive generator.
--dunno how i'll do for the battery, orginal idea was to use the generator's anims. - Atobá
--------------------------------------------------------------------------
...
return Prefab("t1generator", fn, assets, prefabs),
